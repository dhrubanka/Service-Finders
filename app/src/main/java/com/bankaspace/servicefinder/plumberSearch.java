...
public class plumberSearch extends AppCompatActivity {
    //this is the JSON Data URL
    //make sure you are using the correct ip else it will not work
    private static final String URL_PRODUCTS = "http://babydchere.96.lt/plumberSearch.php";
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                adapter = new categoryAdapter(plumberSearch.this, categoryList, new categoryAdapter.OnItemClickListener() {
                                    @Override
                                    public void onItemClick(category item) {
                                        userid=item.getUserId();
                                        Intent intent=new Intent(plumberSearch.this, DetailProfile.class);
