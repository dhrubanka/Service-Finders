...
public class garageSearch extends AppCompatActivity {
    ...
    private static final String URL_PRODUCTS = "http://babydchere.96.lt/garageSearch.php";
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                adapter = new categoryAdapter(garageSearch.this, categoryList, new categoryAdapter.OnItemClickListener() {
                                    @Override
                                    public void onItemClick(category item) {
                                        userid=item.getUserId();
                                        Intent intent=new Intent(garageSearch.this, DetailProfile.class);
