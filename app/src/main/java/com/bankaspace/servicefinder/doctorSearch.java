...
import com.bankaspace.servicefinder.networkcalls.HTTP_Get;
import com.bankaspace.servicefinder.networkcalls.JSONProvider;
...
public class doctorSearch extends AppCompatActivity {
    ...
    private static final String URL_PRODUCTS = "http://babydchere.96.lt/doctorsearch.php";
                ...
                public void onResponse(String response) {
                    try {
                        ...
                        for (int i = 0; i < array.length(); i++) {
                            ...
                            adapter = new categoryAdapter(doctorSearch.this, categoryList, new categoryAdapter.OnItemClickListener() {
                                @Override
                                public void onItemClick(category item) {
                                   userid=item.getUserId();
                                    Intent intent=new Intent(doctorSearch.this, DetailProfile.class);
